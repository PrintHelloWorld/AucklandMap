...
public abstract class GUI {
	...
	/** Calculate route with AStar */
	protected abstract void onFindPath();

	/** display art. points */
	protected abstract void displayArtPoints();
	
	protected abstract void removeArtPoints();
	...
	protected abstract void selectStartNode();

	protected abstract void selectEndNode();
	 ...
	 * minimize, maximize, and close buttons) of your program. Every swing
	...
	private JComponent drawing; // we customize this to make it a drawing pane.
	private JTextArea textOutputArea;

	private JTextField search;
	private JFileChooser fileChooser;

	// Selected Point for searching
	private JButton setStartNodeButton;
	private JButton setEndNodeButton;
	private JButton findPathButton;
	private JToggleButton calculateArtPointsButton;
	...
	private void initialise() {
		...
		setStartNodeButton = new JButton("Start");
		setStartNodeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				selectStartNode();
				redraw();
			}
		...
		setEndNodeButton = new JButton("Dest.");
		setEndNodeButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent ev) {
				selectEndNode();
				redraw();
			}
		...
		calculateArtPointsButton = new JToggleButton("Find Art. Pts");
		calculateArtPointsButton.addItemListener(new ItemListener() {
		...
		// A* Star addition
		controls.add(Box.createRigidArea(new Dimension(15, 0)));
		controls.add(setStartNodeButton);
		controls.add(Box.createRigidArea(new Dimension(5, 0)));
		controls.add(setEndNodeButton);
		controls.add(Box.createRigidArea(new Dimension(5, 0)));
		controls.add(findPathButton);
		controls.add(Box.createRigidArea(new Dimension(5, 0)));
		controls.add(calculateArtPointsButton);
